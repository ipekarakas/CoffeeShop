...
public class KPSPublicSoapProxy implements tr.gov.nvi.tckimlik.WS.KPSPublicSoap {
  ...
  public boolean TCKimlikNoDogrula(String TCKimlikNo, java.lang.String ad, java.lang.String soyad, String dogumYili) throws java.rmi.RemoteException{
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
    return kPSPublicSoap.TCKimlikNoDogrula(TCKimlikNo, ad, soyad, dogumYili);
  }

public boolean TCKimlikNoDogrula(int setNationalId, String firtName, String firtName2, String dateOfBirth) {
